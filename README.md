...
<!-- 📸 Панель администратора: таблица пользователей с колонками ID, логин, email, роль (выпадающий список для смены), статус и кнопка деактивации. -->

```
┌────────────────────────────────────────────────────────┐
│  Панель администратора                                  │
│                                                          │
│  Пользователи | Товары | Заказы | Категории             │
│                                                          │
│  ┌────┬────────┬──────────────────┬────────┬──────────┐ │
│  │ ID │ Логин  │ Email            │ Роль   │ Статус   │ │
│  ├────┼────────┼──────────────────┼────────┼──────────┤ │
│  │ 1  │ admin  │ admin@shop.ru    │ Админ  │ Активен  │ │
│  │ 2  │ seller │ seller@shop.ru   │ Продавец│ Активен  │ │
│  │ 3  │ buyer  │ buyer@mail.com   │ Покуп. │ Активен  │ │
│  └────┴────────┴──────────────────┴────────┴──────────┘ │
└────────────────────────────────────────────────────────┘
``` -->
